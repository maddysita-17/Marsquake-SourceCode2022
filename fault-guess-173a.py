...
def eventoutput(depth,rank):
    ...
    if n == 0:
        data173a.to_csv('./event-by-event/S0173a/csvs/S0173a.csv', header=True)
    else:
        data173a.to_csv('./event-by-event/S0173a/csvs/S0173a.csv', mode='a', header=False)
    ...
    if n == 0:
        data173ab.to_csv('./event-by-event/S0173ab/csvs/S0173ab.csv', header=True)
    else:
        data173ab.to_csv('./event-by-event/S0173ab/csvs/S0173ab.csv', mode='a', header=False)
    return
